#import "../styles/notes.typ": note

= Annexe : Révisions

Les méthodes du cours reposent sur quelques outils d'algèbre linéaire, de
probabilités, de statistiques et de programmation. Cette annexe rassemble les
idées à garder actives pendant la lecture des chapitres.
